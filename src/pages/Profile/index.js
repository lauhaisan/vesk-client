...
<div className="header-extra">Thông tin cơ bản, như tên và hình ảnh của bạn, đang được sử dụng dịch vụ trên Vesk</div>
<div className="box-info">
  <div className="padding-left">
  <div className="detail">Hồ sơ</div>
  <div className="detail-extra">Một số thông tin có thể hiển thị cho những người khác đang sử dụng dịch vụ của Vesk. <a>Tìm hiểu thêm</a></div>
  <div className="row-info">
      <span class="row-info-left">ẢNH &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
      <span class="row-info-right">Một bức ảnh giúp cá nhân hóa tài khoản của bạn</span>
      <span> 
      <img
  ...
  <div className="row-info">
      <span class="row-info-left">TÊN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      <span class="row-info-left">HỌ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      ...
      <span class="row-info-right"> {birthDate || "22/04/1994"} </span>
      <span> 
      <img
         className="row-info-row"
         src={ require("../../images/arrow-right.png")}
  ...
  <div className="row-info">
      <span class="row-info-left">KHU VỰC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      <span class="row-info-left"> ĐIỆN THOẠI&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      <span class="row-info-left">EMAIL &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      <span class="row-info-left">THÀNH PHỐ  &nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <div className="row-info">
      <span class="row-info-left">ĐỊA CHỈ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
